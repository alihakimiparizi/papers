...
%\tt{milton.king@unb.ca,dalhadid@unb.ca,paul.cook@unb.ca}
}
...
author.
% otherwise, it is labeled as not
...
\caption{%Accuracy on \test for each method. Precision (P), recall (R),
 ...
 % shown, as well as macro-average F-score (Avg.\ F).  
